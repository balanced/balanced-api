...
.. code:: javascript

   {
     ...
     "_uris": {}, 
     "state": "pending", 
     "id": "BZ4IClQYcsVJSH24pCC887pC", 
     "attempts": 0, 
     "remaining_attempts": 3, 
     "uri": "/v1/bank_accounts/BA4I0US8EHYSmiza1wHLOc35/verifications/BZ4IClQYcsVJSH24pCC887pC"
   }
...
.. code:: javascript

   {
     ...
     "_uris": {}, 
     "state": "pending", 
     "id": "BZ4K20xfbJVCVJgzrmgXqZEy", 
     "attempts": 0, 
     "remaining_attempts": 3, 
     "uri": "/v1/bank_accounts/BA4JmCZIHukyMcPJAgTmORYz/verifications/BZ4K20xfbJVCVJgzrmgXqZEy"
   }
...
.. code:: javascript
   ...
   {
     "first_uri": "/v1/bank_accounts/BA4KZlFd2SsGwOaRfhXXb7Yj/verifications?limit=10&offset=0", 
     "_type": "page", 
     "items": [
       {
         "_type": "bank_account_authentication", 
         "attempts": 0, 
         "uri": "/v1/bank_accounts/BA4KZlFd2SsGwOaRfhXXb7Yj/verifications/BZ4LydA6aF4MulAuyHSd0ZEO", 
         "state": "pending", 
         "_uris": {}, 
         "id": "BZ4LydA6aF4MulAuyHSd0ZEO", 
         "remaining_attempts": 3
       }
     ], 
     "previous_uri": null, 
     "uri": "/v1/bank_accounts/BA4KZlFd2SsGwOaRfhXXb7Yj/verifications?limit=10&offset=0", 
     "_uris": {
       "first_uri": {
         "_type": "page", 
         "key": "first"
     ...
     "total": 1, 
     "next_uri": null, 
     "last_uri": "/v1/bank_accounts/BA4KZlFd2SsGwOaRfhXXb7Yj/verifications?limit=10&offset=0"
   }
...
.. code:: javascript

   {
     ...
     "_uris": {}, 
     "state": "verified", 
     "id": "BZ4OiNFx0wyEBGokvlhuIPUG", 
     "attempts": 1, 
     "remaining_attempts": 2, 
     "uri": "/v1/bank_accounts/BA4MMPXc2t3S6cl0OcACvYJs/verifications/BZ4OiNFx0wyEBGokvlhuIPUG"
   }
